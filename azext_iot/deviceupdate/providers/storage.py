...
class StorageAccountManager(object):
    ...
    def get_sas_blob_service_client(self, account_name: str) -> BlobServiceClient:
        ...
        # azure-mgmt-storage v23+ returns a MutableMapping model where 'keys' is the
        # built-in dict method — use subscript access to reach the actual field.
        # Older SDK returns a model where 'keys' is a plain list attribute.
